      ...
      <div class="row align-item-center">
        <div class="col-6 col-md-6">
          <div class="topbar-left">
            <p class="mb-0">Get a 20% discount when you subscribe annually </p>
          </div>
        </div>
        <div class="col-6 col-md-6">
          <div class="topbar-right text-end">
            ...
            <a href="#">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-help-circle">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0" />
                <path d="M12 16v.01" />
                <path d="M12 13a2 2 0 0 0 .914 -3.782a1.98 1.98 0 0 0 -2.414 .483" />
              </svg> Get Help </a>
            <div class="topbar-social-media-list">
              <a href="#" class="media">
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-xl-2 col-lg-3 col-6">
            <div class="logo-wrapper">
              <a href="/" class=" only_main_logo" rel="home">
                <img src="https://hostim.themetags.com/wp-content/uploads/2022/09/logo.svg" srcset="https://hostim.themetags.com/wp-content/uploads/2022/09/logo-ratina.svg 2x" class="main-logo page-meta-logo" alt="Hostim">
              </a>
            </div>
          </div>
          <div class="col-xl-10 col-lg-9 col-6 d-flex align-items-center justify-content-end">
            <div class="nav-wrapper d-none d-lg-block ms-auto">
              <nav>
                <ul id="menu-primary-menu" class="navbar-nav menu mx-auto">
                  <li id="menu-item-1350" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1350 menu-item has-submenu ">
                    <a href="#">Hosting</a>
                    <i class="fa fa-angle-down"></i>
                    <ul role="menu" class="icon-menu submenu-wrapper ">
                      <div class="uh_full_menu_innr text-start">
                        <div class="row d-flex">
                          <div class="col-xl-3 col-lg-6 menu_animm_top text-start">
                            <h3 class="menu_title ">Hosting</h3>
                            <p class="menu_desc">Unleash your website with the most powerful hosting in the Middle East and North Africa, starting from personal hosting to corporate hosting..</p>
                          </div>
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="shared-hosting.php" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                                    <path d="M13 21H6C4.11438 21 3.17157 21 2.58579 20.4142C2 19.8284 2 18.8856 2 17C2 15.1144 2 14.1716 2.58579 13.5858C3.17157 13 4.11438 13 6 13H18C19.8856 13 20.8284 13 21.4142 13.5858C22 14.1716 22 15.1144 22 17C22 18.8856 22 19.8284 21.4142 20.4142C20.8284 21 19.8856 21 18 21H17" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" />
                                    <path d="M11 2H18C19.8856 2 20.8284 2 21.4142 2.58579C22 3.17157 22 4.11438 22 6C22 7.88562 22 8.82843 21.4142 9.41421C20.8284 10 19.8856 10 18 10H6C4.11438 10 3.17157 10 2.58579 9.41421C2 8.82843 2 7.88562 2 6C2 4.11438 2 3.17157 2.58579 2.58579C3.17157 2 4.11438 2 6 2H7" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" />
                                ...
                                <div>
                                  ...
                                  <p>Get the highest performance at the lowest price </p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                              </svg>
                            </a>
                            <a class="dropdown-item" href="store-hosting.php" data-load="store-hosting">
                              <div class="info">
                                <span class="navicon">
                                ...
                                <div>
                                  <h6>Store hosting</h6>
                                  <p>Give your customers the best shopping experience</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="professionals-hosting.php" data-load="vds-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24">
                                    <path d="M5 5h1v1H5zm2 1h1V5H7zm2-.001L9.999 6 10 5.001 9.001 5zM22 3v17H2V3zm-1 13H3v3h18zm0-4H3v3h18zm0-4H3v3h18zm0-1V4H3v3zM6 9H5v1h1zm2 0H7v1h1zm2 .001L9.001 9 9 9.999l.999.001zM6 13H5v1h1zm2 0H7v1h1zm2 .001L9.001 13 9 13.999l.999.001zM6 17H5v1h1zm2 0H7v1h1zm2 .001L9.001 17 9 17.999l.999.001z" />
                                    <path fill="none" d="M0 0h24v24H0z" />
                                  </svg>
                                </span>
                                <div>
                                  <h6>Professional hosting</h6>
                                  <p>High performance with moderate economic prices</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <a class="dropdown-item" href="mail-hosting.php" data-load="dedicated-hosting">
                              <div class="info">
                                <span class="navicon">
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="business-hosting.php" data-load="mac-vps-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 -1 22 22" id="meteor-icon-kit__regular-server" fill="none">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                                    <g id="SVGRepo_iconCarrier">
                                      <path fill-rule="evenodd" clip-rule="evenodd" d="M1.35418 13C0.52375 12.2671 0 11.1947 0 10C0 8.8053 0.52375 7.73294 1.35418 7C0.52375 6.26706 0 5.19469 0 4C0 1.79086 1.79086 0 4 0H18C20.2091 0 22 1.79086 22 4C22 5.19469 21.4762 6.26706 20.6458 7C21.4762 7.73294 22 8.8053 22 10C22 11.1947 21.4762 12.2671 20.6458 13C21.4762 13.7329 22 14.8053 22 16C22 18.2091 20.2091 20 18 20H4C1.79086 20 0 18.2091 0 16C0 14.8053 0.52375 13.7329 1.35418 13zM18 12C19.1046 12 20 11.1046 20 10C20 8.8954 19.1046 8 18 8H4C2.89543 8 2 8.8954 2 10C2 11.1046 2.89543 12 4 12H18zM18 6C19.1046 6 20 5.10457 20 4C20 2.89543 19.1046 2 18 2H4C2.89543 2 2 2.89543 2 4C2 5.10457 2.89543 6 4 6H18zM4 3C4.55228 3 5 3.44772 5 4C5 4.55228 4.55228 5 4 5C3.44772 5 3 4.55228 3 4C3 3.44772 3.44772 3 4 3zM4 9C4.55228 9 5 9.4477 5 10C5 10.5523 4.55228 11 4 11C3.44772 11 3 10.5523 3 10C3 9.4477 3.44772 9 4 9zM4 14C2.89543 14 2 14.8954 2 16C2 17.1046 2.89543 18 4 18H18C19.1046 18 20 17.1046 20 16C20 14.8954 19.1046 14 18 14H4zM4 15C4.55228 15 5 15.4477 5 16C5 16.5523 4.55228 17 4 17C3.44772 17 3 16.5523 3 16C3 15.4477 3.44772 15 4 15z" fill="#000000" />
                                    </g>
                                  </svg>
                                </span>
                                <div>
                                  <h6>Business hosting</h6>
                                  <p>Get whm control panel for all your sites</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <a class="dropdown-item" href="wordpress-hosting.php" data-load="gaming-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="800px" height="800px" viewBox="0 0 96.24 96.24" xml:space="preserve">
                                    <g>
                                ...
                                <div>
                                  ...
                                  <p>The best infrastructure for WordPress websites</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li id="menu-item-1350" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1350 menu-item has-submenu ">
                    ...
                    <ul role="menu" class="icon-menu submenu-wrapper ">
                      <div class="uh_full_menu_innr text-start">
                        <div class="row d-flex">
                          <div class="col-xl-3 col-lg-6 menu_animm_top">
                            <h3 class="menu_title">Reseller hosting</h3>
                            <p class="menu_desc">Enhance your income through hosting reseller services. Get the largest space and highest resources at the lowest cost and benefit from them by reselling them.</p>
                          </div>
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="reseller-hosting.php" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="800px" height="800px" viewBox="0 0 24 24">
                                    <path fill-rule="evenodd" d="M19,3 C20.6568542,3 22,4.34314575 22,6 L22,8 C22,9.65685425 20.6568542,11 19,11 L18,11 L18,13 L19,13 C20.6568542,13 22,14.3431458 22,16 L22,18 C22,19.6568542 20.6568542,21 19,21 L5,21 C3.34314575,21 2,19.6568542 2,18 L2,16 C2,14.3431458 3.34314575,13 5,13 L6,13 L6,11 L5,11 C3.34314575,11 2,9.65685425 2,8 L2,6 C2,4.34314575 3.34314575,3 5,3 L19,3 Z M19,15 L5,15 C4.44771525,15 4,15.4477153 4,16 L4,18 C4,18.5522847 4.44771525,19 5,19 L19,19 C19.5522847,19 20,18.5522847 20,18 L20,16 C20,15.4477153 19.5522847,15 19,15 Z M7,16 C7.55228475,16 8,16.4477153 8,17 C8,17.5522847 7.55228475,18 7,18 C6.44771525,18 6,17.5522847 6,17 C6,16.4477153 6.44771525,16 7,16 Z M16,11 L8,11 L8,13 L16,13 L16,11 Z M19,5 L5,5 C4.44771525,5 4,5.44771525 4,6 L4,8 C4,8.55228475 4.44771525,9 5,9 L19,9 C19.5522847,9 20,8.55228475 20,8 L20,6 C20,5.44771525 19.5522847,5 19,5 Z M7,6 C7.55228475,6 8,6.44771525 8,7 C8,7.55228475 7.55228475,8 7,8 C6.44771525,8 6,7.55228475 6,7 C6,6.44771525 6.44771525,6 7,6 Z" />
                                  </svg>
                                </span>
                                <div>
                                  <h6>Reseller</h6>
                                  <p>The lowest cost to start, usually distributing hosting and the highest capabilities at the lowest cost </p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="reseller-master-hosting.php" data-load="vds-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                                    <path d="M2 18C2 17.0681 2 16.6022 2.15224 16.2346C2.35523 15.7446 2.74458 15.3552 3.23463 15.1522C3.60218 15 4.06812 15 5 15H19C19.9319 15 20.3978 15 20.7654 15.1522C21.2554 15.3552 21.6448 15.7446 21.8478 16.2346C22 16.6022 22 17.0681 22 18C22 18.9319 22 19.3978 21.8478 19.7654C21.6448 20.2554 21.2554 20.6448 20.7654 20.8478C20.3978 21 19.9319 21 19 21H5C4.06812 21 3.60218 21 3.23463 20.8478C2.74458 20.6448 2.35523 20.2554 2.15224 19.7654C2 19.3978 2 18.9319 2 18Z" stroke="#1C274C" stroke-width="1.5" />
                                    <path d="M2 12C2 11.0681 2 10.6022 2.15224 10.2346C2.35523 9.74458 2.74458 9.35523 3.23463 9.15224C3.60218 9 4.06812 9 5 9H19C19.9319 9 20.3978 9 20.7654 9.15224C21.2554 9.35523 21.6448 9.74458 21.8478 10.2346C22 10.6022 22 11.0681 22 12C22 12.9319 22 13.3978 21.8478 13.7654C21.6448 14.2554 21.2554 14.6448 20.7654 14.8478C20.3978 15 19.9319 15 19 15H5C4.06812 15 3.60218 15 3.23463 14.8478C2.74458 14.6448 2.35523 14.2554 2.15224 13.7654C2 13.3978 2 12.9319 2 12Z" stroke="#1C274C" stroke-width="1.5" />
                                    <path d="M2 6C2 5.06812 2 4.60218 2.15224 4.23463C2.35523 3.74458 2.74458 3.35523 3.23463 3.15224C3.60218 3 4.06812 3 5 3H19C19.9319 3 20.3978 3 20.7654 3.15224C21.2554 3.35523 21.6448 3.74458 21.8478 4.23463C22 4.60218 22 5.06812 22 6C22 6.93188 22 7.39782 21.8478 7.76537C21.6448 8.25542 21.2554 8.64477 20.7654 8.84776C20.3978 9 19.9319 9 19 9H5C4.06812 9 3.60218 9 3.23463 8.84776C2.74458 8.64477 2.35523 8.25542 2.15224 7.76537C2 7.39782 2 6.93188 2 6Z" stroke="#1C274C" stroke-width="1.5" />
                                ...
                                <div>
                                  ...
                                  <p>is modern in nature, using the latest technologies and with the possibility of redistributing reseller hosting</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="reseller-alpha-hosting.php" data-load="mac-vps-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                                ...
                                <div>
                                  <h6>Alpha Reseller</h6>
                                  <p>You can simply redistribute the hosting and sell Reseller hosting again</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li id="menu-item-1350" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1350 menu-item has-submenu ">
                    ...
                    <ul role="menu" class="icon-menu submenu-wrapper ">
                      <div class="uh_full_menu_innr text-start">
                        <div class="row d-flex">
                          <div class="col-xl-3 col-lg-6 menu_animm_top">
                            <h3 class="menu_title">Servers</h3>
                            <p class="menu_desc"> Modern server solutions of the new generation with the latest technologies and modern and stable infrastructure with a guarantee of 99.99% operation. With multiple data centers, you can choose the one closest to your customers to provide them with the best speed. </p>
                          </div>
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="vps-server.php" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                                    <path d="M6 6H6.01M6 18H6.01M5.2 10H18.8C19.9201 10 20.4802 10 20.908 9.78201C21.2843 9.59027 21.5903 9.28431 21.782 8.90798C22 8.48016 22 7.92011 22 6.8V5.2C22 4.0799 22 3.51984 21.782 3.09202C21.5903 2.71569 21.2843 2.40973 20.908 2.21799C20.4802 2 19.9201 2 18.8 2H5.2C4.07989 2 3.51984 2 3.09202 2.21799C2.71569 2.40973 2.40973 2.71569 2.21799 3.09202C2 3.51984 2 4.07989 2 5.2V6.8C2 7.92011 2 8.48016 2.21799 8.90798C2.40973 9.28431 2.71569 9.59027 3.09202 9.78201C3.51984 10 4.0799 10 5.2 10ZM5.2 22H18.8C19.9201 22 20.4802 22 20.908 21.782C21.2843 21.5903 21.5903 21.2843 21.782 20.908C22 20.4802 22 19.9201 22 18.8V17.2C22 16.0799 22 15.5198 21.782 15.092C21.5903 14.7157 21.2843 14.4097 20.908 14.218C20.4802 14 19.9201 14 18.8 14H5.2C4.07989 14 3.51984 14 3.09202 14.218C2.71569 14.4097 2.40973 14.7157 2.21799 15.092C2 15.5198 2 16.0799 2 17.2V18.8C2 19.9201 2 20.4802 2.21799 20.908C2.40973 21.2843 2.71569 21.5903 3.09202 21.782C3.51984 22 4.0799 22 5.2 22Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                  </svg>
                                </span>
                                <div>
                                  <h6>vps servers</h6>
                                  <p>Excellent servers with high performance and low cost</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="cloud-servers.php" data-load="vds-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                                ...
                                <div>
                                  <h6>Cloud servers</h6>
                                  <p>The ideal experience for ultra-fast cloud servers</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="dedicated-servers.php" data-load="mac-vps-hosting">
                              <div class="info">
                                <span class="navicon">
                                ...
                                <div>
                                  ...
                                  <p>Where power and performance come together in one first-class server</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li id="menu-item-1350" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1350 menu-item has-submenu ">
                    ...
                    <ul role="menu" class="icon-menu submenu-wrapper ">
                      <div class="uh_full_menu_innr text-start">
                        <div class="row d-flex">
                          <div class="col-xl-3 col-lg-6 menu_animm_top">
                            <h3 class="menu_title">Domains</h3>
                            <p class="menu_desc">Explore hundreds of domains and choose the address for your activity in the digital world Search for a domain I am looking for a name that distinguishes my activity in the digital world</p>
                          </div>
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="domain-checker.php" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg class="domains" xmlns="http://www.w3.org/2000/svg" fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" id="icon">
                                    <defs>
                                      <style>
                                        .domains .cls-1 {
                                          fill: none;
                                ...
                                <div>
                                  <h6>Domain search</h6>
                                  <p>Performance meets affordability.</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="domain-transfer.php" data-load="vds-hosting">
                              <div class="info">
                                <span class="navicon">
                  ...
                  <li id="menu-item-1350" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1350 menu-item has-submenu ">
                    ...
                    <ul role="menu" class="icon-menu submenu-wrapper ">
                      <div class="uh_full_menu_innr text-start">
                        <div class="row d-flex">
                          <div class="col-xl-3 col-lg-6 menu_animm_top">
                            <h3 class="menu_title">About Company</h3>
                            <p class="menu_desc">Learn more about our data centers in the company and the technology we use to manage our servers and the latest stable infrastructure.</p>
                          </div>
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="about.php" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                                ...
                                <div>
                                  <h6>About Us</h6>
                                  <p>Learn more about us and find out what our customers say </p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <a class="dropdown-item" href="our-partners.html" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg fill="#000000" width="800px" height="800px" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>cluster-line</title>
                                    <path d="M31.36,8H27.5v2H31V30H27.5v2H33V9.67A1.65,1.65,0,0,0,31.36,8Z" class="clr-i-outline clr-i-outline-path-1"></path>
                                    <path d="M5,10H8.5V8H4.64A1.65,1.65,0,0,0,3,9.67V32H8.5V30H5Z" class="clr-i-outline clr-i-outline-path-2"></path>
                                    <ellipse cx="18.01" cy="25.99" rx="1.8" ry="1.79" class="clr-i-outline clr-i-outline-path-3"></ellipse>
                                    <path d="M24.32,4H11.68A1.68,1.68,0,0,0,10,5.68V32H26V5.68A1.68,1.68,0,0,0,24.32,4ZM24,30H12V6H24Z" class="clr-i-outline clr-i-outline-path-4"></path>
                                    <rect x="13.5" y="9.21" width="9" height="1.6" class="clr-i-outline clr-i-outline-path-5"></rect>
                                    <rect x="0" y="0" width="36" height="36" fill-opacity="0" />
                                  </svg>
                                </span>
                                <div>
                                  <h6>Our Partners</h6>
                                  <p>Our server locations and centers</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="contact.html" data-load="vds-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 499.019 499.019" xml:space="preserve">
                                ...
                                <div>
                                  <h6>Contact us</h6>
                                  <p>You can contact us at any moment</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <a class="dropdown-item" href="customer-reviews.html" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg fill="#000000" width="800px" height="800px" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    ...
                                    <path class="clr-i-outline clr-i-outline-path-2" d="M18,20.63a1,1,0,0,0,1-1V8.48a1,1,0,1,0-2,0V19.61A1,1,0,0,0,18,20.63Z"></path>
                                    <circle class="clr-i-outline clr-i-outline-path-3" cx="18" cy="24.04" r="1.33"></circle>
                                    <rect x="0" y="0" width="36" height="36" fill-opacity="0" />
                                  </svg>
                                </span>
                                <div>
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="brand.html" data-load="mac-vps-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="800px" height="800px" viewBox="0 0 32 32" enable-background="new 0 0 32 32" version="1.1" xml:space="preserve" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                                    <g id="SVGRepo_iconCarrier">
                                      <g id="Layer_2" />
                                      ...
                                      <g id="Layer_24">
                                        <g>
                                          <path d="M17.7998,13.75c-0.2813,0-0.5615-0.1187-0.7588-0.3491c-0.3599-0.4194-0.3115-1.0508,0.1084-1.4102 l8.6904-7.4502c0.4189-0.3579,1.0508-0.3101,1.4092,0.1084c0.3604,0.4194,0.3115,1.0508-0.1084,1.4102l-8.6904,7.4502 C18.2617,13.6709,18.0303,13.75,17.7998,13.75z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M26.4902,27.7002c-0.2305,0-0.4619-0.0791-0.6504-0.2407l-8.6904-7.4502 c-0.4199-0.3594-0.4683-0.9907-0.1084-1.4102c0.3594-0.4194,0.9912-0.4668,1.4092-0.1084l8.6904,7.4502 c0.4199,0.3594,0.4688,0.9907,0.1084,1.4102C27.0518,27.5815,26.7715,27.7002,26.4902,27.7002z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M7.1201,23.8799c-0.2559,0-0.5117-0.0977-0.707-0.293c-0.3906-0.3906-0.3906-1.0234,0-1.4141 l3.3398-3.3398c0.3906-0.3906,1.0234-0.3906,1.4141,0s0.3906,1.0234,0,1.4141l-3.3398,3.3398 C7.6318,23.7822,7.376,23.8799,7.1201,23.8799z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M10.46,13.46c-0.2559,0-0.5117-0.0977-0.707-0.293L6.4131,9.8271c-0.3906-0.3906-0.3906-1.0234,0-1.4141 s1.0234-0.3906,1.4141,0l3.3398,3.3398c0.3906,0.3906,0.3906,1.0234,0,1.4141C10.9717,13.3623,10.7158,13.46,10.46,13.46z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M24,17h-5c-0.5527,0-1-0.4478-1-1s0.4473-1,1-1h5c0.5527,0,1,0.4478,1,1S24.5527,17,24,17z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M14,22c-1.5957,0-3.1025-0.6211-4.2432-1.749C8.6211,19.1025,8,17.5957,8,16s0.6211-3.1025,1.749-4.2432 C10.8975,10.6211,12.4043,10,14,10c1.75,0,3.4111,0.7646,4.5576,2.0981C19.4873,13.1763,20,14.5625,20,16 s-0.5127,2.8237-1.4424,3.9028C17.4111,21.2354,15.75,22,14,22z M14,12c-1.0654,0-2.0732,0.416-2.8369,1.1709 C10.416,13.9268,10,14.9346,10,16s0.416,2.0732,1.1709,2.8369C11.9268,19.584,12.9346,20,14,20 c1.167,0,2.2754-0.5112,3.042-1.4019C17.6602,17.8809,18,16.9585,18,16s-0.3398-1.8809-0.958-2.5972 C16.2754,12.5112,15.167,12,14,12z" fill="0" />
                                        </g>
                                        <g>
                                          <path d="M5,11c-2.2056,0-4-1.7944-4-4s1.7944-4,4-4s4,1.7944,4,4S7.2056,11,5,11z M5,5C3.897,5,3,5.897,3,7 s0.897,2,2,2s2-0.897,2-2S6.103,5,5,5z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M28,7c-1.6543,0-3-1.3457-3-3s1.3457-3,3-3s3,1.3457,3,3S29.6543,7,28,7z M28,3c-0.5518,0-1,0.4487-1,1 s0.4482,1,1,1s1-0.4487,1-1S28.5518,3,28,3z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M26,19c-1.6543,0-3-1.3457-3-3s1.3457-3,3-3s3,1.3457,3,3S27.6543,19,26,19z M26,15 c-0.5518,0-1,0.4487-1,1s0.4482,1,1,1s1-0.4487,1-1S26.5518,15,26,15z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M28,31c-1.6543,0-3-1.3457-3-3s1.3457-3,3-3s3,1.3457,3,3S29.6543,31,28,31z M28,27 c-0.5518,0-1,0.4487-1,1s0.4482,1,1,1s1-0.4487,1-1S28.5518,27,28,27z" fill="" />
                                        </g>
                                        <g>
                                          <path d="M5,29c-2.2056,0-4-1.7944-4-4s1.7944-4,4-4s4,1.7944,4,4S7.2056,29,5,29z M5,23c-1.103,0-2,0.897-2,2 s0.897,2,2,2s2-0.897,2-2S6.103,23,5,23z" fill="" />
                                        </g>
                                      </g>
                                      <g id="Layer_25" />
                                      <g id="Layer_26" />
                                ...
                                <div>
                                  <h6>The Brand</h6>
                                  <p>Learn about the latest technologies used in managing our servers</p>
                                </div>
                              </div>
                              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.33333 14.1668L12.5 10.0002L8.33333 5.8335" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <a class="dropdown-item" href="payment-method.php" data-load="mac-vps-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="800px" height="800px" viewBox="0 0 32 32" enable-background="new 0 0 32 32" version="1.1" xml:space="preserve" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                   ...
                   <li id="menu-item-1350" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-1350 menu-item has-submenu ">
                    ...
                    <ul role="menu" class="icon-menu submenu-wrapper ">
                      <div class="uh_full_menu_innr text-start">
                        <div class="row d-flex">
                          <div class="col-xl-3 col-lg-6 menu_animm_top text-start">
                            <h3 class="menu_title ">Technology</h3>
                            <p class="menu_desc">Unleash your website with the most powerful hosting in the Middle East and North Africa, starting from personal hosting to corporate hosting..</p>
                          </div>
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="data-center.php" data-load="shared-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                                    <path d="M13 21H6C4.11438 21 3.17157 21 2.58579 20.4142C2 19.8284 2 18.8856 2 17C2 15.1144 2 14.1716 2.58579 13.5858C3.17157 13 4.11438 13 6 13H18C19.8856 13 20.8284 13 21.4142 13.5858C22 14.1716 22 15.1144 22 17C22 18.8856 22 19.8284 21.4142 20.4142C20.8284 21 19.8856 21 18 21H17" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" />
                             ...
                             <a class="dropdown-item" href="service-status.php" data-load="store-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 -0.5 25 25" fill="none">
                                    <path d="M10.9426 8.674C10.9426 8.25979 10.6068 7.924 10.1926 7.924C9.77842 7.924 9.44263 8.25979 9.44263 8.674H10.9426ZM15.5566 8.674C15.5566 8.25979 15.2208 7.924 14.8066 7.924C14.3924 7.924 14.0566 8.25979 14.0566 8.674H15.5566ZM9.44274 8.66112C9.43563 9.07527 9.76559 9.41677 10.1797 9.42389C10.5939 9.43101 10.9354 9.10104 10.9425 8.68688L9.44274 8.66112ZM10.9525 8.10488C10.9596 7.69073 10.6297 7.34923 10.2155 7.34211C9.80136 7.33499 9.45986 7.66496 9.45274 8.07912L10.9525 8.10488ZM10.9201 8.85645C11.0209 8.45468 10.7769 8.04729 10.3751 7.94653C9.97331 7.84577 9.56593 8.08978 9.46516 8.49155L10.9201 8.85645ZM10.0356 9.3L10.7613 9.48948L10.7631 9.48245L10.0356 9.3ZM8.60872 10.8759L8.8691 11.5792H8.8691L8.60872 10.8759ZM6.927 9.99268C6.58662 9.75665 6.11934 9.84124 5.88331 10.1816C5.64728 10.522 5.73187 10.9893 6.07226 11.2253L6.927 9.99268ZM7.24959 10.6167C7.25384 10.2025 6.92151 9.86328 6.50732 9.85904C6.09312 9.85479 5.75392 10.1871 5.74967 10.6013L7.24959 10.6167ZM6.44463 15.976L7.19458 15.985L7.19459 15.9837L6.44463 15.976ZM7.02186 17.4058L6.48838 17.9329H6.48838L7.02186 17.4058ZM8.44463 18V17.25H8.44458L8.44463 18ZM10.4996 18.75C10.9138 18.75 11.2496 18.4142 11.2496 18C11.2496 17.5858 10.9138 17.25 10.4996 17.25V18.75ZM6.07039 11.224C6.41006 11.4611 6.87759 11.3779 7.11465 11.0382C7.35172 10.6986 7.26854 10.231 6.92887 9.99398L6.07039 11.224ZM5.57863 8.092L4.87557 7.83085C4.86723 7.85329 4.85997 7.87612 4.85382 7.89926L5.57863 8.092ZM6.41363 5.844L7.1167 6.10515C7.12393 6.08569 7.13034 6.06594 7.13593 6.04594L6.41363 5.844ZM7.52263 5V4.25L7.52046 4.25L7.52263 5ZM17.4756 5L17.4778 4.25H17.4756V5ZM18.5846 5.844L17.8623 6.04595C17.8679 6.0659 17.8743 6.08562 17.8815 6.10505L18.5846 5.844ZM19.4196 8.093L20.1445 7.90034C20.1383 7.87721 20.1311 7.85439 20.1227 7.83195L19.4196 8.093ZM18.0701 9.99422C17.7305 10.2315 17.6476 10.699 17.8848 11.0386C18.1221 11.3781 18.5897 11.461 18.9
 7.70959 18.7501 8.44469 18.75L8.44458 17.25C8.11044 17.25 7.7902 17.1163 7.55535 16.8786L6.48838 17.9329ZM8.44463 18.75H10.4996V17.25H8.44463V18.75ZM6.92887 9.99398C6.38194 9.61226 6.13204 8.92931 6.30344 8.28474L4.85382 7.89926C4.52041 9.15305 5.00651 10.4815 6.07039 11.224L6.92887 9.99398ZM6.2817 8.35315L7.1167 6.10515L5.71057 5.58285L4.87557 7.83085L6.2817 8.35315ZM7.13593 6.04594C7.18473 5.8714 7.34356 5.75052 7.5248 5.75L7.52046 4.25C6.66795 4.25247 5.92088 4.82103 5.69133 5.64206L7.13593 6.04594ZM7.52263 5.75H17.4756V4.25H7.52263V5.75ZM17.4735 5.75C17.6547 5.75052 17.8135 5.8714 17.8623 6.04595L19.3069 5.64205C19.0774 4.82103 18.3303 4.25247 17.4778 4.25L17.4735 5.75ZM17.8815 6.10505L18.7165 8.35405L20.1227 7.83195L19.2877 5.58295L17.8815 6.10505ZM18.6948 8.28566C18.866 8.92987 18.6164 9.61242 18.0701 9.99422L18.9292 11.2238C19.9921 10.4811 20.4775 9.15344 20.1445 7.90034L18.6948 8.28566ZM11.2496 18V15H9.74963V18H11.2496ZM11.2496 15C11.2496 14.8619 11.3616 14.75 11.4996 14.75V13.25C10.5331 13.25 9.74963 14.0335 9.74963 15H11.2496ZM11.4996 14.75H13.4996V13.25H11.4996V14.75ZM13.4996 14.75C13.6377 14.75 13.7496 14.8619 13.7496 15H15.2496C15.2496 14.0335 14.4661 13.25 13.4996 13.25V14.75ZM13.7496 15V18H15.2496V15H13.7496ZM10.4996 18.75H14.4996V17.25H10.4996V18.75ZM15.5566 8.66498L15.5496 8.08298L14.0497 8.10102L14.0567 8.68302L15.5566 8.66498ZM14.0824 8.85727L14.2394 9.48027L15.6939 9.11373L15.5369 8.49073L14.0824 8.85727ZM14.2409 9.48622C14.492 10.4494 15.1973 11.2294 16.1304 11.5759L16.6526 10.1698C16.1784 9.99367 15.82 9.59726 15.6924 9.10778L14.2409 9.48622ZM16.1304 11.5759C17.0635 11.9225 18.107 11.7919 18.926 11.226L18.0733 9.99195C17.6571 10.2795 17.1268 10.3459 16.6526 10.1698L16.1304 11.5759ZM17.7497 10.6163L17.8017 15.9833L19.3016 15.9687L19.2496 10.6017L17.7497 10.6163ZM17.8017 15.985C17.8057 16.3191 17.6758 16.6409 17.4409 16.8786L18.5079 17.9329C19.0246 17.41 19.3104 16.702 19.3016 15.967L17.8017 15.985ZM17.4409 16.8786C17.2061 17.1163 16.8858 17.25 16.5517 17.25L16.5516 18.75C17.2867 18.7501 17.9912 18.4558 18.5079 17.9329L17.4409 16.8786ZM16.5516 17.25H14.4996V18.75H16.5516V17.25Z" fill="#000000" />
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="protection.html" data-load="vds-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24">
                                    <path d="M5 5h1v1H5zm2 1h1V5H7zm2-.001L9.999 6 10 5.001 9.001 5zM22 3v17H2V3zm-1 13H3v3h18zm0-4H3v3h18zm0-4H3v3h18zm0-1V4H3v3zM6 9H5v1h1zm2 0H7v1h1zm2 .001L9.001 9 9 9.999l.999.001zM6 13H5v1h1zm2 0H7v1h1zm2 .001L9.001 13 9 13.999l.999.001zM6 17H5v1h1zm2 0H7v1h1zm2 .001L9.001 17 9 17.999l.999.001z" />
                            ...
                            <a class="dropdown-item" href="technology.php" data-load="dedicated-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 1024 1024" class="icon" version="1.1" fill="#000000">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                          ...
                          <div class="col-xl-3 col-lg-6 menu_animm_side">
                            <a class="dropdown-item" href="blog.html" data-load="mac-vps-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 -1 22 22" id="meteor-icon-kit__regular-server" fill="none">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                            ...
                            <a class="dropdown-item" href="control-panel.html" data-load="gaming-hosting">
                              <div class="info">
                                <span class="navicon">
                                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="800px" height="800px" viewBox="0 0 96.24 96.24" xml:space="preserve">
                                    <g>
            ...
            <div class="header-right d-flex align-items-center justify-content-end d-lg-none">
...
<div class="mobile-menu position-fixed bg-white deep-shadow">
  ...
  <nav class="mobile-menu-wrapper mt-40">
    <ul id="menu-primary-menu-1" class="navbar-nav menu mx-auto">
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1010 menu-item menu_half_width mega-menu">
        <a href="#"> Hosting </a>
        <i class="fa fa-angle-down"></i>
        <ul role="menu" class="icon-menu submenu-wrapper ">
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2010 menu-item depth-1">
            <a href="shared-hosting.php">Shared hosting</a>
          </li>
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1892 menu-item depth-1">
            <a href="professionals-hosting.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24">
                <path d="M5 5h1v1H5zm2 1h1V5H7zm2-.001L9.999 6 10 5.001 9.001 5zM22 3v17H2V3zm-1 13H3v3h18zm0-4H3v3h18zm0-4H3v3h18zm0-1V4H3v3zM6 9H5v1h1zm2 0H7v1h1zm2 .001L9.001 9 9 9.999l.999.001zM6 13H5v1h1zm2 0H7v1h1zm2 .001L9.001 13 9 13.999l.999.001zM6 17H5v1h1zm2 0H7v1h1zm2 .001L9.001 17 9 17.999l.999.001z" />
                <path fill="none" d="M0 0h24v24H0z" />
              </svg> Professional hosting </a>
          </li>
          <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5717 menu-item">
            <a href="business-hosting.php">
              ...
              </svg> Business hosting </a>
          </li>
          <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5717 menu-item">
            <a href="store-hosting.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 -0.5 25 25" fill="none">
                <path d="M10.9426 8.674C10.9426 8.25979 10.6068 7.924 10.1926 7.924C9.77842 7.924 9.44263 8.25979 9.44263 8.674H10.9426ZM15.5566 8.674C15.5566 8.25979 15.2208 7.924 14.8066 7.924C14.3924 7.924 14.0566 8.25979 14.0566 8.674H15.5566ZM9.44274 8.66112C9.43563 9.07527 9.76559 9.41677 10.1797 9.42389C10.5939 9.43101 10.9354 9.10104 10.9425 8.68688L9.44274 8.66112ZM10.9525 8.10488C10.9596 7.69073 10.6297 7.34923 10.2155 7.34211C9.80136 7.33499 9.45986 7.66496 9.45274 8.07912L10.9525 8.10488ZM10.9201 8.85
11.2496 15C11.2496 14.8619 11.3616 14.75 11.4996 14.75V13.25C10.5331 13.25 9.74963 14.0335 9.74963 15H11.2496ZM11.4996 14.75H13.4996V13.25H11.4996V14.75ZM13.4996 14.75C13.6377 14.75 13.7496 14.8619 13.7496 15H15.2496C15.2496 14.0335 14.4661 13.25 13.4996 13.25V14.75ZM13.7496 15V18H15.2496V15H13.7496ZM10.4996 18.75H14.4996V17.25H10.4996V18.75ZM15.5566 8.66498L15.5496 8.08298L14.0497 8.10102L14.0567 8.68302L15.5566 8.66498ZM14.0824 8.85727L14.2394 9.48027L15.6939 9.11373L15.5369 8.49073L14.0824 8.85727ZM14.2409 9.48622C14.492 10.4494 15.1973 11.2294 16.1304 11.5759L16.6526 10.1698C16.1784 9.99367 15.82 9.59726 15.6924 9.10778L14.2409 9.48622ZM16.1304 11.5759C17.0635 11.9225 18.107 11.7919 18.926 11.226L18.0733 9.99195C17.6571 10.2795 17.1268 10.3459 16.6526 10.1698L16.1304 11.5759ZM17.7497 10.6163L17.8017 15.9833L19.3016 15.9687L19.2496 10.6017L17.7497 10.6163ZM17.8017 15.985C17.8057 16.3191 17.6758 16.6409 17.4409 16.8786L18.5079 17.9329C19.0246 17.41 19.3104 16.702 19.3016 15.967L17.8017 15.985ZM17.4409 16.8786C17.2061 17.1163 16.8858 17.25 16.5517 17.25L16.5516 18.75C17.2867 18.7501 17.9912 18.4558 18.5079 17.9329L17.4409 16.8786ZM16.5516 17.25H14.4996V18.75H16.5516V17.25Z" fill="#000000" />
              </svg> Store hosting </a>
          </li>
          <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5717 menu-item">
            <a href="mail-hosting.html">
              <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 1024 1024" class="icon" version="1.1" fill="#000000">
                <g id="SVGRepo_bgCarrier" stroke-width="0" />
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                <g id="SVGRepo_iconCarrier">
      ...
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1010 menu-item menu_half_width mega-menu">
        ...
        <ul role="menu" class="icon-menu submenu-wrapper ">
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2010 menu-item depth-1">
            <a href="reseller-hosting.php">Reseller</a>
          </li>
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1892 menu-item depth-1">
            <a href="reseller-master-hosting.php">Master Reseller</a>
          </li>
          <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5717 menu-item">
            <a href="reseller-alpha-hosting.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.5155 15.7248C3.78702 15.7062 4.13391 15.7059 4.63158 15.7059H19.3684C19.8661 15.7059 20.213 15.7062 20.4845 15.7248C20.7513 15.7431 20.9067 15.7774 21.0253 15.8268C21.4122 15.988 21.7196 16.2972 21.8798 16.6863C21.9289 16.8056 21.963 16.9619 21.9812 17.2303C21.9997 17.5034 22 17.8523 22 18.3529C22 18.8535 21.9997 19.2025 21.9812 19.4756C21.963 19.744 21.9289 19.9002 21.8798 20.0196C21.7196 20.4087 21.4122 20.7179 21.0253 20.8791C20.9067 20.9285 20.7513 20.9628 20.4845 20.9811C20.213 20.9997 19.8661 21 19.3684 21H4.63158C4.13391 21 3.78702 20.9997 3.5155 20.9811C3.2487 20.9628 3.09333 20.9285 2.97471 20.8791C2.58782 20.7179 2.28044 20.4087 2.12019 20.0196C2.07105 19.9002 2.03701 19.744 2.01881
0588C4.05023 13.0588 3.57895 12.5848 3.57895 12C3.57895 11.4152 4.05023 10.9412 4.63158 10.9412C5.21293 10.9412 5.68421 11.4152 5.68421 12ZM4.63158 6.70588C5.21293 6.70588 5.68421 6.23183 5.68421 5.64706C5.68421 5.06229 5.21293 4.58824 4.63158 4.58824C4.05023 4.58824 3.57895 5.06229 3.57895 5.64706C3.57895 6.23183 4.05023 6.70588 4.63158 6.70588Z" fill="#1C274C" />
              </svg> Alpha Reseller </a>
          </li>
        </ul>
      </li>
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1010 menu-item menu_half_width mega-menu">
        ...
        <ul role="menu" class="icon-menu submenu-wrapper ">
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2010 menu-item depth-1">
            <a href="vps-server.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                <path d="M6 6H6.01M6 18H6.01M5.2 10H18.8C19.9201 10 20.4802 10 20.908 9.78201C21.2843 9.59027 21.5903 9.28431 21.782 8.90798C22 8.48016 22 7.92011 22 6.8V5.2C22 4.0799 22 3.51984 21.782 3.09202C21.5903 2.71569 21.2843 2.40973 20.908 2.21799C20.4802 2 19.9201 2 18.8 2H5.2C4.07989 2 3.51984 2 3.09202 2.21799C2.71569 2.40973 2.40973 2.71569 2.21799 3.09202C2 3.51984 2 4.07989 2 5.2V6.8C2 7.92011 2 8.48016 2.21799 8.90798C2.40973 9.28431 2.71569 9.59027 3.09202 9.78201C3.51984 10 4.0799 10 5.2 10ZM5.2 22H18.8C19.9201 22 20.4802 22 20.908 21.782C21.2843 21.5903 21.5903 21.2843 21.782 20.908C22 20.4802 22 19.9201 22 18.8V17.2C22 16.0799 22 15.5198 21.782 15.092C21.5903 14.7157 21.2843 14.4097 20.908 14.218C20.4802 14 19.9201 14 18.8 14H5.2C4.07989 14 3.51984 14 3.09202 14.218C2.71569 14.4097 2.40973 14.7157 2.21799 15.092C2 15.5198 2 16.0799 2 17.2V18.8C2 19.9201 2 20.4802 2.21799 20.908C2.40973 21.2843 2.71569 21.5903 3.09202 21.782C3.51984 22 4.0799 22 5.2 22Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg> vps servers </a>
          </li>
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1892 menu-item depth-1">
            <a href="cloud-servers.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                <path d="M22 14.3529C22 17.4717 19.4416 20 16.2857 20H11M14.381 9.02721C14.9767 8.81911 15.6178 8.70588 16.2857 8.70588C16.9404 8.70588 17.5693 8.81468 18.1551 9.01498M7.11616 11.6089C6.8475 11.5567 6.56983 11.5294 6.28571 11.5294C3.91878 11.5294 2 13.4256 2 15.7647C2 18.1038 3.91878 20 6.28571 20H7M7.11616 11.6089C6.88706 10.9978 6.7619 10.3369 6.7619 9.64706C6.7619 6.52827 9.32028 4 12.4762 4C15.4159 4 17.8371 6.19371 18.1551 9.01498M7.11616 11.6089C7.68059 11.7184 8.20528 11.9374 8.66667 12.2426M18.1551 9.01498C18.8381 9.24853 19.4623 9.60648 20 10.0614" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"></path>
              </svg> Cloud servers </a>
          </li>
          <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5717 menu-item">
      ...
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1010 menu-item menu_half_width mega-menu">
        ...
        <ul role="menu" class="icon-menu submenu-wrapper ">
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2010 menu-item depth-1">
            <a href="domain-checker.php">Domain search</a>
          </li>
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1892 menu-item depth-1">
      ...
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1010 menu-item menu_half_width mega-menu">
        ...
        <ul role="menu" class="icon-menu submenu-wrapper ">
          ...
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1352 menu-item depth-1">
            <a href="brand.html">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 499.019 499.019" xml:space="preserve">
                <path d="M499.019,427.479c0-8.413-3.277-16.323-9.227-22.272L387.969,303.382c-12.282-12.281-32.266-12.279-44.548,0l-28.284,28.284  c-4.033,4.033-6.898,9.095-8.287,14.64l-0.91,3.643c-24.406-19.88-59.186-52.017-82.02-74.851  c-22.835-22.835-54.971-57.614-74.85-82.019l3.646-0.911c5.541-1.388,10.602-4.253,14.635-8.286l5.65-5.65  c0.002-0.002,0.005-0.004,0.007-0.006s0.004-0.005,0.006-0.007l22.621-22.622c12.281-12.281,12.281-32.266,0-44.548L93.812,9.227  c-5.949-5.95-13.859-9.227-22.272-9.227c0,0,0,0-0.001,0c-8.414,0-16.324,3.276-22.274,9.226L17.948,40.544  C-0.588,59.08-5.278,88.1,6.276,112.759c30.215,64.487,93.718,150.136,161.783,218.201  c68.065,68.065,153.713,131.568,218.197,161.78c9.015,4.225,18.611,6.277,28.066,6.277c16.411,0,32.393-6.187,44.153-17.946  l8.688-8.688l0.001-0.001c0,0,0.001-0.001,0.001-0.001l22.626-22.626C495.742,443.804,499.019,435.893,499.019,427.479z   M59.871,19.834c3.117-3.117,7.261-4.834,11.668-4.833c4.407,0,8.55,1.716,11.667,4.833L185.03,121.656  c6.433,6.434,6.433,16.902,0,23.335l-17.324,17.324L42.547,37.158L59.871,19.834z M392.62,479.158  c-63.037-29.534-147.02-91.869-213.955-158.805c-66.935-66.935-129.27-150.918-158.807-213.957  c-8.883-18.96-5.389-41.161,8.696-55.245l3.386-3.386l125.157,125.157l-0.353,0.353c-2.113,2.113-4.766,3.615-7.669,4.342  l-14.921,3.729c-2.45,0.612-4.427,2.417-5.261,4.801c-0.833,2.384-0.412,5.026,1.123,7.032  c20.726,27.092,61.186,70.416,83.297,92.527c22.109,22.108,65.433,62.568,92.526,83.297c2.006,1.534,4.649,1.955,7.033,1.123  c2.384-0.834,4.188-2.812,4.801-5.262l3.728-14.918c0.728-2.906,2.229-5.56,4.342-7.672l0.353-0.353l125.158,125.158l-3.386,3.386  C433.784,484.549,411.582,488.045,392.62,479.158z M479.186,439.147l-17.324,17.325L336.704,331.314l17.324-17.324  c6.433-6.433,16.902-6.435,23.335,0l101.823,101.824c3.117,3.116,4.833,7.259,4.833,11.666  C484.019,431.887,482.303,436.031,479.186,439.147z" />
              </svg> The Brand </a>
      ...
      <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1010 menu-item menu_half_width mega-menu">
        ...
        <ul role="menu" class="icon-menu submenu-wrapper ">
          <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2010 menu-item depth-1">
            <a href="data-center.php">Data Centers</a>
          </li>
          <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5717 menu-item">
  ...
  <div class="contact-info mt-60">
    ...
    <a href="#" class="template-btn primary-btn mt-4">Get Started</a>
  </div>
</div>
<!-- HEADER AREA END -->