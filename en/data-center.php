...
<head>
    ...
    <title>Data Center - Web Hosting & WHMCS Template</title>
...
<div class="hero-area-coodiv position-relative landing-page-bg-hero light-mode-texts">
    <div class="container position-relative coodiv-z-index-2 pt-20 pb-lg-35 pb-15">
                        <div class="row justify-content-center mb-8">
                            <div class="col-md-9 col-lg-7 col-xl-9">
                                ...
                                <div class="hero-content dark-mode-texts mb-15 mb-lg-10 text-center text-md-center">
                                    <h1 class="coodiv-text-4 d-block mb-4">Hosty data centers</h1>
                                    <p class="coodiv-text-8 px-7 mb-0 mb-10">Official partnerships between more than 9 data centers in various parts of the world</p>
                                </div>
                            </div>
                        </div>
                        <img class="w-100" src="assets/images/server-dedicated.webp" alt="">
    </div>
    <div class="header-hero-backgrounds">
        <svg class="bg-wave-box-end-z1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#fff" fill-opacity="1" d="M0,0L34.3,16C68.6,32,137,64,206,80C274.3,96,343,96,411,96C480,96,549,96,617,117.3C685.7,139,754,181,823,186.7C891.4,192,960,160,1029,170.7C1097.1,181,1166,235,1234,234.7C1302.9,235,1371,181,1406,154.7L1440,128L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
        </svg>
    </div>
</div>

<div class="dc-first-sec">
    <div class="container">
        <div class="row g-4">
            <div class="col-12">
                <div class="d-flex justify-content-center border-bottom border-light border-opacity-10" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                    <div class="pricing-nav-pills d-inline-block mx-auto overflow-x-auto">
                        <ul class="nav nav-pills flex-nowrap gap-3 gap-sm-0" role="tablist">
                            <li class="nav-item flex-shrink-0 tab_title_style__" role="presentation">
                                <a class="partner-tab-nev d-inline-block text-decoration-none text-white fw-bold px-3 pb-2 active" href="#" data-bs-toggle="pill" data-bs-target="#location_alllocation" aria-selected="false" role="tab" tabindex="-1">
                                       All Location                                 </a>
                            </li>
                            <li class="nav-item flex-shrink-0 tab_title_style__" role="presentation">
                                <a class="partner-tab-nev d-inline-block text-decoration-none text-white fw-bold px-3 pb-2" href="#" data-bs-toggle="pill" data-bs-target="#location_europe" aria-selected="false" role="tab" tabindex="-1">
                                        Europe                                    </a>
                            </li>
                            <li class="nav-item flex-shrink-0 tab_title_style__" role="presentation">
                                <a class="partner-tab-nev d-inline-block text-decoration-none text-white fw-bold px-3 pb-2" href="#" data-bs-toggle="pill" data-bs-target="#location_asia" aria-selected="true" role="tab">
                                        Asia                                    </a>
                            </li>
                            <li class="nav-item flex-shrink-0 tab_title_style__" role="presentation">
                                <a class="partner-tab-nev d-inline-block text-decoration-none text-white fw-bold px-3 pb-2" href="#" data-bs-toggle="pill" data-bs-target="#location_arabworld" aria-selected="false" role="tab" tabindex="-1">
                                       Arab World                              </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="col-12">
                <div class="tab-content" data-sal="fade" data-sal-duration="1000" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                    <div class="tab-pane fade active show" id="location_alllocation" role="tabpanel">
                        <div class="row g-4">
                             <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img fetchpriority="high" decoding="async" width="264" height="196" src="assets/images/img-88.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/germany-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__">  Frankfurt </h6><small class="fw-medium region_style__"> Germany </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                                        <!--<a href="#" class="text-decoration-none px-3 py-1 rounded-pill border text-body fs-12"><small>Web Hosting</small></a>-->
                                        <!--<a href="#" class="text-decoration-none px-3 py-1 rounded-pill border text-body fs-12"><small>Website Builder</small></a>-->
                                        <!--<a href="#" class="text-decoration-none px-3 py-1 rounded-pill border text-body fs-12"><small>Cloud</small></a>-->
                                    </div>
                                    <button type="submit" class="btn btn-sm btn-dark__ fw-semibold hover:bg-primary hover:border-primary mt-5 btn_style__"> Speed Text </button>
                                    <p class="mb-0 mt-3 ip_address_style__">IP Address:<span class="fw-bold">45.56.127.148</span></p>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="264" height="196" src="assets/images/img-86.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/germany-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Frankfurt </h6><small class="fw-medium region_style__"> Germany </small> </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="264" height="196" src="assets/images/img-87.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/finland-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Helsinki </h6><small class="fw-medium region_style__"> Finland </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="262" height="196" src="assets/images/img-85.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/img-89.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Las Angeles </h6><small class="fw-medium region_style__"> USA </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img fetchpriority="high" decoding="async" width="264" height="196" src="assets/images/img-88.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/india-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Delhi </h6><small class="fw-medium region_style__"> India </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="264" height="196" src="assets/images/img-86.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/japan-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Tokyo </h6><small class="fw-medium region_style__"> Japan </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="264" height="196" src="assets/images/img-87.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/turkey-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Istanbul </h6><small class="fw-medium region_style__"> Türkiye </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="262" height="196" src="assets/images/img-85.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/saudi-arabia-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Riyadh </h6><small class="fw-medium region_style__">  Saudi Arabia </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                             ...
                             <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    ...
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/saudi-arabia-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__">Saudi Arabia </h6></div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="264" height="196" src="assets/images/img-86.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/united-arab-emirates-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__">United Arab Emirates </h6></div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="264" height="196" src="assets/images/img-87.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/kuwait-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Kuwait </h6></div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img loading="lazy" decoding="async" width="262" height="196" src="assets/images/img-85.png" class="img-fluid w-100" alt="image">
                                    <div class="d-flex align-items-center gap-3 mt-5 mb-3">
                                        <img decoding="async" width="44" height="44" src="assets/images/iraq-flag-round-circle-icon.png" class="img-fluid" alt="image">
                                        <div>
                                            <h6 class="mb-0 country_name_style__"> Baghdad </h6><small class="fw-medium region_style__">  Iraq </small> </div>
                                    </div>
                                    <small class="fw-bold subtitle_style__"> Available Products </small>
                                    <div class="d-flex align-items-center gap-2 flex-wrap mt-3">
                                        coming soon
                    ...
                    <div class="tab-pane fade" id="location_europe" role="tabpanel">
                        <div class="row g-4">
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img fetchpriority="high" decoding="async" width="264" height="196" src="assets/images/img-88.png" class="img-fluid w-100" alt="image">
                    ...
                    <div class="tab-pane fade " id="location_asia" role="tabpanel">
                       <div class="row g-4">
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img fetchpriority="high" decoding="async" width="264" height="196" src="assets/images/img-88.png" class="img-fluid w-100" alt="image">
                    ...
                    <div class="tab-pane fade" id="location_arabworld" role="tabpanel">
                        <div class="row g-4">
                            <div class="col-xl-3 col-md-6">
                                <div class="bg-white__ p-6__ rounded-3 shadow-sm hover-shadow transition sect_style__">
                                    <img fetchpriority="high" decoding="async" width="264" height="196" src="assets/images/img-88.png" class="img-fluid w-100" alt="image">
...
<!--<section class="dc-second-sec pat-100 pab-20 homeServiceMap secTopBotGap pax-20 pax-xxl-0 bg-white pab-100">-->
<!--    <div class="container">-->
<!--        <div class="row">-->
<!--            <div class="themeHeading mab-50 d-flex flex-wrap flex-sm-nowrap justify-content-center text-center">-->
<!--                <div class="footerTopContent fs-16 fs-lg-16 fs-xxl-18 lh-26 lh-xxl-30 le-mb-0">-->
<!--                    <h2 class="fcontTitle fs-22 fs-xl-28 fs-xxl-30 fw-600 mab-10">Multiple Datacenter Locations</h2></div>-->
<!--            </div>-->
<!--        </div>-->
<!--        <div class="serverMap-right">-->
<!--            <div class="row justify-content-between">-->
<!--                <div class="col">-->
<!--                    <h5>5</h5><span>Continents</span></div>-->
<!--                <div class="col">-->
<!--                    <h5>13</h5><span>Countries</span></div>-->
<!--                <div class="col">-->
<!--                    <h5>17</h5><span>Locations</span></div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
<!--</section>-->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-790 text-center">
                    <h3 class="rts-section__title" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Distinctive geographical locations</h3>
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">We work with more than three data centers spread across 5 different continents, where we provide the best protection systems through global partnerships.</p>
                </div>
            </div>
            <!-- data center content -->
            <div class="row">
                <div class="col-12">
                    <div class="rts-data-center__location">
                        <img src="assets/images/map.png" alt="data__center">
                        <ul class="round-shape">
                             <li class="one">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="Germany" aria-label="Germany"></span>
        <img src="assets/images/flag-02.svg" alt="">
    </li>
    <li class="two">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="USA" aria-label="USA"></span>
        <img src="assets/images/flag-04.svg" alt="">
    </li>
    <li class="three">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="Egypt" aria-label="Egypt"></span>
        <img src="assets/images/flag-05.svg" alt="">
    </li>
    <li class="four">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="Sudan" aria-label="Sudan"></span>
        <img src="assets/images/Flag_of_Sudan.svg" alt="">
    </li>
    <li class="five">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="Turkey" aria-label="Turkey"></span>
        <img src="assets/images/Flag_of_Turkey.svg" alt="">
    </li>
    <li class="six">
        <img src="assets/images/Flag_of_Japan.svg" alt="">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="Japan" aria-label="Japan"></span>
    </li>
     <li class="seven">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="Finland" aria-label="Finland"></span>
        <img src="assets/images/Flag_of_Finland.svg" alt="">
    </li>
     <li class="eight">
        <span class="tolltip1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="color-hostie" title="" data-bs-original-title="Britain" aria-label="Britain"></span>
        <img src="assets/images/Flag_of_United_Kingdom.svg" alt="">
    </li>
</ul>
                    </div>
                </div>
...
<section class="dataServer-seciton pay-60 bg-lightblue">
    <div class="container">
        <div class="row mab-30 section-head-mobile">
            <div class="themeHeading text-center">
                <h2 class="headingTitle fs-24 fs-xxl-38 fs-xl-36 fs-lg-28 fw-700 mab-20">A global network built for Web Hosting</h2>
                <div class="thParaSec fs-16 fs-xl-20 lh-34 mw-900px mx-auto">
                    <p>Eleven data centers enable us to provide disaster recovery options and help distribute traffic between locations.</p>
                </div>
            </div>
        </div>
        <div class="row location-list justify-content-center">
            <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    ...
                    <div><span>Helsinki, Finland</span>
                        <div class="dataServer-div-ms" id="helsinki">
                            <p>Latency: <span style="color: rgb(255, 35, 35);">19062ms</span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    ...
                    <div><span>Tokyo, Japan</span>
                        <div class="dataServer-div-ms" id="tokyo">
                            <p>Latency: <span style="color: rgb(255, 35, 35);">470ms</span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    ...
                    <div><span>Istanbul, Turkey</span>
                        <div class="dataServer-div-ms" id="turkey">
                            <p>Latency: <span style="color: rgb(255, 35, 35);">328ms</span></p>
                        </div>
                        <div class="dataServer-div-download"> </div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row location-list justify-content-center">
           <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    ...
                    <div><span>Frankfurt, Germany</span>
                        <div class="dataServer-div-ms" id="germany">
                            <p>Latency: <span style="color: rgb(224, 206, 47);">197ms</span></p>
                        </div>
                        <div class="dataServer-div-download"> </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    <svg id="Layer_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="256" cy="256" fill="#f0f0f0" r="256"></circle>
                        <g fill="#d80027">
                            <path d="m244.87 256h267.13c0-23.106-3.08-45.49-8.819-66.783h-258.311z"></path>
                            <path d="m244.87 122.435h229.556c-15.671-25.572-35.708-48.175-59.07-66.783h-170.486z"></path>
                            <path d="m256 512c60.249 0 115.626-20.824 159.356-55.652h-318.712c43.73 34.828 99.107 55.652 159.356 55.652z"></path>
                            <path d="m37.574 389.565h436.852c12.581-20.529 22.338-42.969 28.755-66.783h-494.362c6.417 23.814 16.174 46.254 28.755 66.783z"></path>
                        </g>
                        <path d="m118.584 39.978h23.329l-21.7 15.765 8.289 25.509-21.699-15.765-21.699 15.765 7.16-22.037c-19.106 15.915-35.852 34.561-49.652 55.337h7.475l-13.813 10.035c-2.152 3.59-4.216 7.237-6.194 10.938l6.596 20.301-12.306-8.941c-3.059 6.481-5.857 13.108-8.372 19.873l7.267 22.368h26.822l-21.7 15.765 8.289 25.509-21.699-15.765-12.998 9.444c-1.301 10.458-1.979 21.11-1.979 31.921h256c0-141.384 0-158.052 0-256-50.572 0-97.715 14.67-137.416 39.978zm9.918 190.422-21.699-15.765-21.699 15.765 8.289-25.509-21.7-15.765h26.822l8.288-25.509 8.288 25.509h26.822l-21.7 15.765zm-8.289-100.083 8.289 25.509-21.699-15.765-21.699 15.765 8.289-25.509-21.7-15.765h26.822l8.288-25.509 8.288 25.509h26.822zm100.115 100.083-21.699-15.765-21.699 15.765 8.289-25.509-21.7-15.765h26.822l8.288-25.509 8.288 25.509h26.822l-21.7 15.765zm-8.289-100.083 8.289 25.509-21.699-15.765-21.699 15.765 8.289-25.509-21.7-15.765h26.822l8.288-25.509 8.288 25.509h26.822zm0-74.574 8.289 25.509-21.699-15.765-21.699 15.765 8.289-25.509-21.7-15.765h26.822l8.288-25.509 8.288 25.509h26.822z" fill="#0052b4"></path>
                        <g></g>
                        <g></g>
                        <g></g>
                        <g></g>
                    ...
                    <div> <span>Los Angeles, USA</span>
                        <div class="dataServer-div-ms" id="losangeles">
                            <p>Latency: <span style="color: rgb(255, 35, 35);">350ms</span></p>
                        </div>
                        <div class="dataServer-div-download"> </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    ...
                    <div> <span>Saudi Arabia (soon)</span>
                        <div class="dataServer-div-ms" id="losangeles">
                            <p>Latency: <span style="color: rgb(255, 35, 35);"></span></p>
                        </div>
                        <div class="dataServer-div-download"> </div>
                    </div>
                </div>
        ...
        <div class="row location-list justify-content-center">
            <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    ...
                    <div><span>Iraq soon</span>
                        <div class="dataServer-div-ms" id="iraq">
                            <p>Latency: </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 dataServer-div">
                <div class="dataServer-div-flag d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 512"><g fill-rule="nonzero"><path fill="#4D4D4D" d="M256 0c70.684 0 134.689 28.664 181.012 74.987C483.336 121.311 512 185.316 512 256c0 70.684-28.664 134.689-74.988 181.013C390.689 483.336 326.684 512 256 512c-70.677 0-134.689-28.664-181.013-74.987C28.664 390.689 0 326.676 0 256c0-70.684 28.664-134.689 74.987-181.013C121.311 28.664 185.316 0 256 0z"/><path fill="#fff" d="M256.001 19.597c65.278 0 124.382 26.466 167.162 69.242 42.776 42.78 69.242 101.884 69.242 167.162S465.939 380.384 423.16 423.16c-42.777 42.78-101.881 69.246-167.159 69.246-65.278 0-124.382-26.466-167.162-69.243-42.777-42.779-69.243-101.884-69.243-167.162S46.062 131.619 88.839 88.839c42.78-42.776 101.884-69.242 167.162-69.242z"/><path fill="#007A3D" d="M459.973 183.57H52.029C81.822 99.674 161.887 39.594 256.001 39.594c94.111 0 174.179 60.08 203.972 143.976z"/><path fill="#fff" d="M52.029 183.57h407.944c8.042 22.646 12.435 47.025 12.435 72.431s-4.393 49.782-12.435 72.431H52.029c-8.042-22.649-12.435-47.025-12.435-72.431s4.393-49.785 12.435-72.431z"/><path fill="#CE1126" d="M52.029 328.432h407.944c-29.793 83.894-109.861 143.976-203.972 143.976-94.114 0-174.179-60.082-203.972-143.976z"/><path d="M98.253 107.872l113.545 75.698v144.862L98.253 404.131c-36.367-38.718-58.659-90.817-58.659-148.13s22.292-109.412 58.659-148.129z"/></g></svg>
                    <div><span>Kuwait soon</span>
                        <div class="dataServer-div-ms" id="kuwait">
                            <p>Latency: </p>
                        </div>
                    </div>
                </div>
...
<g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)" >
	...
	<path d="M 30 87.429 l 0 -84.858 C 12.524 8.75 0 25.408 0 45 S 12.524 81.25 30 87.429 z" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: rgb(247,0,0); fill-rule: nonzero; opacity: 1;" transform=" matrix(1 0 0 1 0 0) " stroke-linecap="round" />
                    ...
                    <div><span>UAE soon</span>
                        <div class="dataServer-div-ms" id="uae">
                            <p>Latency: </p>
                        </div>
                        <div class="dataServer-div-download"> </div>
                    </div>
        ...
        <!--                <g></g>-->
        <!--            </svg>-->
        <!--            <div><span>New York, USA</span>-->
        <!--                <div class="dataServer-div-ms" id="newyork">-->
        <!--                    <p>Latency: <span style="color: rgb(255, 35, 35);">362ms</span></p>-->
        <!--                </div>-->
        <!--                <div class="dataServer-div-download"> </div>-->
        <!--            </div>-->
        <!--        </div>-->
        ...
        <!--                <circle cx="256" cy="256" fill="#f0f0f0" r="256"></circle>-->
        <!--                <g fill="#d80027">-->
        <!--                    <path d="m512 256c0-101.494-59.065-189.19-144.696-230.598v461.195c85.631-41.407 144.696-129.103 144.696-230.597z"></path>-->
        <!--                    <path d="m0 256c0 101.494 59.065 189.19 144.696 230.598v-461.196c-85.631 41.408-144.696 129.104-144.696 230.598z"></path>-->
        <!--                    <path d="m300.522 289.391 44.521-22.261-22.26-11.13v-22.261l-44.522 22.261 22.261-44.522h-22.261l-22.261-33.391-22.261 33.391h-22.261l22.261 44.522-44.522-22.261v22.261l-22.26 11.13 44.521 22.261-11.13 22.261h44.522v33.391h22.26v-33.391h44.522z"></path>-->
        <!--                </g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        ...
        <!--                <g></g>-->
        <!--            </svg>-->
        <!--            <div><span>Toronto, Canada</span>-->
        <!--                <div class="dataServer-div-ms" id="canada">-->
        <!--                    <p>Latency: <span style="color: rgb(255, 35, 35);">351ms</span></p>-->
        <!--                </div>-->
        <!--                <div class="dataServer-div-download"> </div>-->
        <!--            </div>-->
        <!--        </div>-->
        ...
        <!--                </g>-->
        <!--            </svg>-->
        <!--            <div> <span>London, United Kingdom</span>-->
        <!--                <div class="dataServer-div-ms" id="london">-->
        <!--                    <p>Latency: <span style="color: rgb(237, 88, 47);">218ms</span></p>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--    </div>-->
        ...
        <!--            <svg id="Layer_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">-->
        <!--                <circle cx="256" cy="256" fill="#f0f0f0" r="256"></circle>-->
        <!--                <path d="m0 256.001c0-141.385 114.616-256.001 256-256.001s256 114.616 256 256.001" fill="#d80027"></path>-->
        <!--                <g fill="#f0f0f0">-->
        <!--                    <path d="m155.826 133.564c0-37.298 26.213-68.456 61.217-76.101-5.38-1.174-10.961-1.811-16.696-1.811-43.031 0-77.913 34.882-77.913 77.913s34.882 77.913 77.913 77.913c5.733 0 11.315-.637 16.696-1.812-35.004-7.645-61.217-38.803-61.217-76.102z"></path>-->
        <!--                    <path d="m256 61.217 5.526 17.005h17.881l-14.467 10.511 5.526 17.005-14.466-10.509-14.466 10.509 5.526-17.005-14.466-10.511h17.88z"></path>-->
        <!--                    <path d="m212.625 94.608 5.525 17.006h17.881l-14.466 10.51 5.526 17.005-14.466-10.509-14.468 10.509 5.527-17.005-14.467-10.51h17.881z"></path>-->
        <!--                    <path d="m299.376 94.608 5.527 17.006h17.88l-14.467 10.51 5.527 17.005-14.467-10.509-14.466 10.509 5.526-17.005-14.466-10.51h17.88z"></path>-->
        <!--                    <path d="m282.681 144.695 5.526 17.006h17.88l-14.466 10.51 5.526 17.005-14.466-10.509-14.466 10.509 5.526-17.005-14.466-10.51h17.879z"></path>-->
        <!--                    <path d="m229.32 144.695 5.525 17.006h17.882l-14.467 10.51 5.527 17.005-14.467-10.509-14.467 10.509 5.526-17.005-14.466-10.51h17.881z"></path>-->
        <!--                </g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        ...
        <!--                <g></g>-->
        <!--            </svg>-->
        <!--            <div><span>Singapore</span>-->
        <!--                <div class="dataServer-div-ms" id="singapore">-->
        <!--                    <p>Latency: <span style="color: rgb(224, 206, 47);">148ms</span></p>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--    </div>-->
        <!--</div>-->
        <!--<div class="row location-list justify-content-center">-->
        <!--    <div class="col-md-4 dataServer-div fastest">-->
        <!--        <div class="dataServer-div-flag d-flex align-items-center">-->
        <!--            <svg id="Layer_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">-->
        <!--                <circle cx="256" cy="256" fill="#f0f0f0" r="256"></circle>-->
        <!--                <path d="m256 0c-101.494 0-189.19 59.065-230.598 144.696h461.195c-41.407-85.631-129.104-144.696-230.597-144.696z" fill="#ff9811"></path>-->
        <!--                <path d="m256 512c101.493 0 189.19-59.065 230.598-144.696h-461.196c41.408 85.631 129.104 144.696 230.598 144.696z" fill="#6da544"></path>-->
        <!--                <circle cx="256" cy="256" fill="#0052b4" r="89.043"></circle>-->
        <!--                <circle cx="256" cy="256" fill="#f0f0f0" r="55.652"></circle>-->
        <!--                <path d="m256 187.326 17.169 38.938 42.304-4.601-25.136 34.337 25.136 34.337-42.304-4.601-17.169 38.938-17.169-38.938-42.304 4.6 25.136-34.336-25.136-34.337 42.304 4.601z" fill="#0052b4"></path>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        ...
        <!--                <g></g>-->
        <!--            </svg>-->
        <!--            <div><span>New Delhi, India</span>-->
        <!--                <div class="dataServer-div-ms" id="india">-->
        <!--                    <p>Latency: <span style="color: rgb(101, 206, 108);">89ms</span></p>-->
        <!--                </div>-->
        <!--                <div class="dataServer-div-download"> </div>-->
        <!--            </div>-->
        <!--        </div>-->
        ...
        <!--            <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">-->
        <!--                <circle cx="256" cy="256" fill="#f0f0f0" r="256"></circle>-->
        <!--                <path d="m74.98 437.02c-99.974-99.975-99.974-262.065 0-362.04-.007.011 147.629 181.02 147.629 181.02z"></path>-->
        <!--                <path d="m222.609 256-188.656-127.487c-5.849 10.167-11.007 20.779-15.439 31.763l95.509 95.725-95.506 95.73c4.428 10.976 9.581 21.581 15.426 31.741z" fill="#ffda44"></path>-->
        <!--                <path d="m509.833 222.609h-287.231l-147.624-147.625c-15.908 15.908-29.729 33.899-41.025 53.53l127.239 127.486-127.249 127.47c11.296 19.636 25.123 37.633 41.035 53.545l147.624-147.624h287.231c1.423-10.93 2.167-22.074 2.167-33.391s-.744-22.461-2.167-33.391z"-->
        <!--                fill="#6da544"></path>-->
        <!--                <path d="m100.138 459.077c43.169 33.182 97.206 52.923 155.862 52.923 118.279 0 217.805-80.221 247.181-189.217h-266.748z" fill="#0052b4"></path>-->
        <!--                <path d="m503.181 189.217c-29.376-108.996-128.902-189.217-247.181-189.217-58.656 0-112.693 19.741-155.862 52.923l136.294 136.294z" fill="#d80027"></path>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        ...
        <!--                <g></g>-->
        <!--            </svg>-->
        <!--            <div><span>Johannesburg, Africa</span>-->
        <!--                <div class="dataServer-div-ms" id="johannesburg">-->
        <!--                    <p>Latency: <span style="color: rgb(255, 35, 35);">386ms</span></p>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--    </div>-->
        ...
        <!--                <path d="m256 100.174 211.478 155.826-211.478 155.826-211.478-155.826z" fill="#ffda44"></path>-->
        <!--                <circle cx="256" cy="256" fill="#f0f0f0" r="89.043"></circle>-->
        <!--                <g fill="#0052b4">-->
        <!--                    <path d="m211.478 250.435c-15.484 0-30.427 2.355-44.493 6.725.623 48.64 40.227 87.884 89.015 87.884 30.168 0 56.812-15.017 72.919-37.968-27.557-34.497-69.958-56.641-117.441-56.641z"></path>-->
        <!--                    <path d="m343.393 273.06c1.072-5.524 1.651-11.223 1.651-17.06 0-49.178-39.866-89.043-89.043-89.043-36.694 0-68.194 22.201-81.826 53.899 12.05-2.497 24.526-3.812 37.305-3.812 51.717-.001 98.503 21.497 131.913 56.016z"></path>-->
        <!--                </g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        ...
        <!--                <g></g>-->
        <!--            </svg>-->
        <!--            <div><span>Sao Paulo, Brazil</span>-->
        <!--                <div class="dataServer-div-ms" id="saopaulo">-->
        <!--                    <p>Latency: <span style="color: rgb(255, 35, 35);">371ms</span></p>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--    </div>-->
        ...
        <!--            <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">-->
        <!--                <circle cx="256" cy="256" fill="#f0f0f0" r="256"></circle>-->
        <!--                <path d="m512 256c0-101.494-59.065-189.19-144.696-230.598v461.195c85.631-41.407 144.696-129.103 144.696-230.597z" fill="#d80027"></path>-->
        <!--                <g fill="#6da544">-->
        <!--                    <path d="m0 256c0 101.494 59.065 189.19 144.696 230.598v-461.196c-85.631 41.408-144.696 129.104-144.696 230.598z"></path>-->
        <!--                    <path d="m189.217 256c0 36.883 29.9 66.783 66.783 66.783s66.783-29.9 66.783-66.783v-22.261h-133.566z"></path>-->
        <!--                </g>-->
        <!--                <path d="m345.043 211.478h-66.783c0-12.294-9.967-22.261-22.261-22.261s-22.261 9.967-22.261 22.261h-66.783c0 12.295 10.709 22.261 23.002 22.261h-.741c0 12.295 9.966 22.261 22.261 22.261 0 12.295 9.966 22.261 22.261 22.261h44.522c12.295 0 22.261-9.966 22.261-22.261 12.295 0 22.261-9.966 22.261-22.261h-.742c12.295 0 23.003-9.966 23.003-22.261z"-->
        <!--                fill="#ff9811"></path>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        <!--                <g></g>-->
        ...
        <!--                <g></g>-->
        <!--            </svg>-->
        <!--            <div><span>Mexico City, Mexico</span>-->
        <!--                <div class="dataServer-div-ms" id="mexico">-->
        <!--                    <p>Latency: <span style="color: rgb(255, 35, 35);">374ms</span></p>-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--    </div>-->
...
<div class="dataServer-three-section uk-section">
    <div class="uk-container">
        <div class="tm-grid-expand uk-child-width-1-1 uk-grid-margin uk-grid uk-grid-stack" uk-grid="">
            <div class="uk-width-1-1 uk-first-column">
                <div class="uk-panel uk-margin-remove-first-child uk-margin-medium uk-text-center">
                    <h4 class="el-title uk-h3 uk-margin-top uk-margin-remove-bottom">                        Features                    </h4>
                    <div class="el-content uk-panel uk-margin-top">
                        <p>Essential Features in all of our plans</p>
                    </div>
                </div>
            </div>
        </div>
         <div class="row features-list-row" >
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/control.svg" width="121" height="125" alt="cPanel/Plesk control panel" class="el-image entered lazyloaded">
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                        cPanel/Plesk control panel                    </h6>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/ssl.svg" width="129" height="125" alt="Free SSL  Certificate" class="el-image entered lazyloaded" title="ssl" data-lazy-src="/uploads/2022/03/ssl.svg" data-ll-status="loaded">
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                        Free SSL  Certificate                    </h6>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/softaculous-installer.svg" width="129" height="125" class="el-image entered lazyloaded" >
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                        Softaculous Installer                    </h6>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/full-support.svg" width="129" height="125" class="el-image entered lazyloaded">
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                        Full Technical  Support                    </h6>
                        </div>
                    </div>
                 </div>
                <div class="row features-list-row" >
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/standard-security.svg" alt="standard security" class="el-image entered lazyloaded">
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                        Monarx Malware Scanner                    </h6>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/clinux.svg" width="129" height="125" alt="CloudLinux OS" class="el-image entered lazyloaded" >
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                        CloudLinux OS                    </h6>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/server-monitor.svg" width="129" height="125" class="el-image entered lazyloaded">
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                         24/7/365 Server Monitoring                    </h6>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="el-item uk-card uk-card-secondary uk-card-small uk-card-body uk-margin-remove-first-child">
                            <img decoding="async" src="assets/images/backup.svg" width="132" height="125" class="el-image entered lazyloaded" >
                            <h6 class="el-title uk-card-title uk-margin-top uk-margin-remove-bottom">                        Daily, Weekly and Monthly Backup                    </h6>
                        </div>
                    </div>
                </div>
    </div>
...
<div class="pm-faq">
    <div class="container">
        ...
        <div class="section-content m-w-lg m-a">
            <div class="panel-faq-group accordion" id="accordion-475-1">
                <div class="faq-item   faq-item-boxed" id="faq-collapse-1-1" data-toggle="collapse" data-target="#faq-475-1-1" aria-expanded="true">
                    <div class="faq-item-top panel-heading">
                        <h3 class="h5">What is website hosting?</h3>
                        <div class="accordion-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                <g clip-path="url(#clip0_1015_66215)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5 8H0.5C0.22 8 0 8.22 0 8.5V9.5C0 9.78 0.22 10 0.5 10H5H8H10H15H17.5C17.78 10 18 9.78 18 9.5V8.5C18 8.22 17.78 8 17.5 8H15H10H8H5Z" fill=" #6944d6"></path>
                                </g>
                                <g class="plus-vert" clip-path="url(#clip1_1015_66215)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10 0.5C10 0.22 9.78 0 9.5 0H8.5C8.22 0 8 0.22 8 0.5V8V10V17.5C8 17.78 8.22 18 8.5 18H9.5C9.78 18 10 17.78 10 17.5V10V8V0.5Z" fill=" #6944d6"></path>
                                </g>
                                <defs>
                                    <clipPath id="clip0_1015_66215">
                                        <rect width="18" height="2" fill="white" transform="translate(0 8)"></rect>
                                    </clipPath>
                                    <clipPath id="clip1_1015_66215">
                                        <rect width="2" height="18" fill="white" transform="translate(8)"></rect>
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
                    </div>
                    <div id="faq-475-1-1" class="panel-collapse collapse show" aria-expanded="true" style="" data-parent="#accordion-475-1">
                        <div class="faq-item-bottom">
                            <p>Web hosting is a service that lets you rent web space on the internet to publish a web site. Email services are usually also included in most web hosting packages. Same goes for the domain registration of your first site name.
                                The domain name is the address people enter in their browsers to access a specific website.
                                <br>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="faq-item collapsed  faq-item-boxed" id="faq-collapse-1-3" data-toggle="collapse" data-target="#faq-475-1-3" aria-expanded="false">
                    <div class="faq-item-top panel-heading">
                    ...
                    <div id="faq-475-1-3" class="panel-collapse collapse " aria-expanded="true" style="" data-parent="#accordion-475-1">
                        <div class="faq-item-bottom">
                            <p>Shared hosting is the most widely used and affordable type of hosting service. In shared hosting, many websites share the space of one physical server and its resources. Cloud hosting is much more powerful as you get a whole
                                server all by yourself and you don't share its resources with anyone.
                                <br>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="faq-item collapsed  faq-item-boxed" id="faq-collapse-1-2" data-toggle="collapse" data-target="#faq-475-1-2" aria-expanded="false">
                    <div class="faq-item-top panel-heading">
                    ...
                    <div id="faq-475-1-2" class="panel-collapse collapse " aria-expanded="true" style="" data-parent="#accordion-475-1">
                        <div class="faq-item-bottom">
                            <p>Cloud hosting is the ability to make applications and websites available on the internet using the cloud. Cloud hosting pools computing resources from a network of virtual and physical servers, allowing for greater scalability
                                and flexibility to quickly make changes. In most cases cloud hosting is also pay-as-you-go which means the teams pay for what they use and don’t have to worry about overprovisioning or underprovisioning resources.
                                <br>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="faq-item collapsed  faq-item-boxed" id="faq-collapse-1-4" data-toggle="collapse" data-target="#faq-475-1-4" aria-expanded="false">
                    <div class="faq-item-top panel-heading">
                    ...
                    <div id="faq-475-1-4" class="panel-collapse collapse " aria-expanded="true" style="" data-parent="#accordion-475-1">
                        <div class="faq-item-bottom">
                            <p>Yes, for the most part, shared hosting is secure. Our servers have security solutions in place at the server level. However, in most cases, security problems like malware across a shared server only occurs because one or more
                                hosting customers weren’t diligent in keeping their website’s software up-to-date
                                <br>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="faq-item collapsed  faq-item-boxed" id="faq-collapse-1-5" data-toggle="collapse" data-target="#faq-475-1-5" aria-expanded="false">
                    <div class="faq-item-top panel-heading">
                        <h3 class="h5">What does unlimited hosting mean?</h3>
                        <div class="accordion-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                <g clip-path="url(#clip0_1015_66215)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5 8H0.5C0.22 8 0 8.22 0 8.5V9.5C0 9.78 0.22 10 0.5 10H5H8H10H15H17.5C17.78 10 18 9.78 18 9.5V8.5C18 8.22 17.78 8 17.5 8H15H10H8H5Z" fill=" #6944d6"></path>
                    ...
                    <div id="faq-475-1-5" class="panel-collapse collapse " aria-expanded="true" style="" data-parent="#accordion-475-1">
                        <div class="faq-item-bottom">
                            Unlimited cloud storage providers automatically scan your hard drive and search for content that needs to be backed up. Once you begin the process, the tool copies all the data to a remote data center.
                        </div>
                    </div>
                </div>
            </div>
